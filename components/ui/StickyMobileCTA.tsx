...
export function StickyMobileCTA() {
  ...
  useEffect(() => {
    ...
    // Hide when footer enters the viewport so it never overlaps footer links
  ...
  return (
    <div
      className={cn(
        ...
        isVisible && !footerVisible ? "translate-y-0 opacity-100" : "pointer-events-none translate-y-8 opacity-0",
      )}
    >
      <div
        className={cn(
